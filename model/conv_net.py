...
class ConvNet(torch.nn.Module):
    ...
    def __init__(self, resolution, num_classes):
        ...
        '''
        self.resolution = resolution  # input dimension: resolution x resolution
        self.features = torch.nn.Sequential(
            torch.nn.Conv2d(3, 6, (3, 3), (1, 1), 1),
            # For each conv layer, height and width dimensions stay the same, while channelx2.
            torch.nn.ReLU(),
        ...
        # MaxPool2d: torch.nn.MaxPool2d(kernel_size, stride=None, padding=0, dilation=1, return_indices=False,
        # ceil_mode=False)
